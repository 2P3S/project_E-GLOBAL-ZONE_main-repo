		...
		<div className='footer'>
			<div className='footer_area'>
				<p className='copyright'>
					대표전화 053-940-511441527 대구광역시 북구 복현로 35 (복현2동 218) 영진전문대학교
				...
				<div className='family_site'>
					<select
						...
						<option value='https://www.yju.ac.kr/en'>영진전문대학교 영문홈페이지</option>
						<option value='https://www.yju.ac.kr/cn'>영진전문대학교 중문홈페이지</option>
						<option value='https://www.yju.ac.kr/jp'>영진전문대학교 일문홈페이지</option>
						<option value='https://ipsi.yju.ac.kr'>영진전문대학교 입학홈페이지</option>
						<option value='http://iacf.yju.ac.kr'>영진전문대학교 산학협력단</option>
						<option value='http://job.yju.ac.kr'>영진전문대학교 종합인력개발센터</option>
						...
						<option value='http://www.yjservice.or.kr'>영진전문대학교 사회봉사단</option>
