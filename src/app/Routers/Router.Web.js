		...
		<>
			<div className="head">
				<div className="head_area">
					...
					<ul className="menu">
						<li>
							<a href="/schedules/now">스케줄 및 예약관리</a>
						</li>
						<li>
							<a href="/students/now/korean">학생관리</a>
						</li>
						<li>
							<a href="/students/now/foreigner">유학생관리</a>
						</li>
						<li>
							<a href="/settings">시스템 환경설정</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div className="footer_area">
					...
					<div className="family_site">
						<select name="catgo" className="dropdown">
							...
							<option value="https://www.yju.ac.kr">
								영진전문대학교 국문홈페이지
							</option>
							...
							<option value="https://ipsi.yju.ac.kr">
								영진전문대학교 입학홈페이지
							</option>
							...
							<option value="https://dguav.yju.ac.kr">
								대구경북무인항공전문교육원
							</option>
							<option value="http://www.ycc.ac.kr">영진사이버대학교</option>
							<option value="https://child.yju.ac.kr">
								영진전문대학교 부설 유치원
							</option>
